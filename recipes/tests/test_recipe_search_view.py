...
class RecipeSearchViewsTest(RecipeTestBase):
    ...
    def test_recipe_search_can_find_recipe_by_title(self):
        ...
        reponse_both = self.client.get(f'{search_url}?search=this')
        ...
        self.assertIn(recipe1, reponse_both.context['recipes'])
        self.assertIn(recipe2, reponse_both.context['recipes'])

   
    def test_recipe_search_can_find_recipe_by_title_and_page_invalid(self):
        title1 = 'This is recipe one'
        title2 = 'This is recipe two'
        ...
        search_url = reverse('recipes:search')
        response1 = self.client.get(f'{search_url}?page=a&search={title1}')
        response2 = self.client.get(f'{search_url}?page=a&search={title2}')
